...
module.exports = class astrologerModel {
    ...
    addReview(data) {
        return knex("tb_astrologer_review").insert(data);
    }
    likeReview(data,callback){
        let review_id=data.Id
        delete data.Id
        return knex("tb_astrologer_review")
        .update(data)
        .where("id", review_id)
    ...
    deletReview(reviewid) {
        console.log("reviwiiwiwiw id ",reviewid);
        return knex("tb_astrologer_review")
            .where('Id',reviewid)
            .del();
    }
