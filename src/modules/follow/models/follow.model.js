...
module.exports = class followModel {
    constructor() { }
    ...
    getFollowing(userId){
        ...
        console.log("userrerererer", userId);
        let obj= knex.select("*")
        .from("tb_mst_follow")
        .innerJoin("tb_mst_astrologer","tb_mst_astrologer.Id","tb_mst_follow.astroId")
        .where("tb_mst_follow.userId",userId.userId)

        console.log("objjjjjjjj", obj.toString());
    ...
    getAstroFollowers(astroId){
        console.log("userrerererer", astroId);
        let obj= knex.select("*")
        .from("tb_mst_follow")
        .innerJoin("tb_mst_user","tb_mst_user.Id","tb_mst_follow.userId")
        .where("tb_mst_follow.astroId",astroId.astroId)
    ...
    addUserFollowing(data){
        console.log("datattatat in modelll",data);

        let obj=knex("tb_mst_follow").insert(data);
